...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'type', name: 'Type', meta: { name: '一级分类' }, component: () => import('../views/manager/Type') },
      { path: 'secondType', name: 'SecondType', meta: { name: '二级分类' }, component: () => import('../views/manager/SecondType') },
