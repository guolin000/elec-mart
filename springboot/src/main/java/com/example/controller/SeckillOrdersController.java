...
import com.example.service.SeckillOrdersService;
...
public class SeckillOrdersController {
    ...
    @Autowired
    @Qualifier("seckillOrdersService")
    private SeckillOrdersService ordersService;

    /**
     * 新增
     */
    @PostMapping("/add")
    public Result add(@RequestBody SeckillOrders orders) {
     ...
     */
    @PutMapping("/update")
    public Result updateById(@RequestBody SeckillOrders orders) {
    ...
    public Result selectById(@PathVariable Integer id) {
        SeckillOrders orders = ordersService.selectById(id);
    ...
    public Result selectAll(SeckillOrders orders ) {
        List<SeckillOrders> list = ordersService.selectAll(orders);
    ...
    public Result selectPage(SeckillOrders orders,
                             @RequestParam(defaultValue = "1") Integer pageNum,
                             @RequestParam(defaultValue = "10") Integer pageSize) {
        PageInfo<SeckillOrders> page = ordersService.selectPage(orders, pageNum, pageSize);
