 ...
 */
@RestController
@RequestMapping("/seckillalipay")
public class SeckillAliPayController {
    ...
    @Resource
    private SeckillOrdersMapper orderMapper;
...
//        System.out.println("!!!!!"+Integer.valueOf(orderNo));
        List<SeckillOrders> orders = orderMapper.selectByOrderNo(orderNo);
        if (orders ==null){
            return ;
        }
